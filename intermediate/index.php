...
// function averageSalary($totalSalary)
// {
//   $total = 0;
//   foreach ($totalSalary as $salary) {
//     $total += $salary;
//   }
//   $averageSalary = $total / count($salary);

//   return $averageSalary;
// }

function calculateAvgSalary($jobListings)
{
...
function calculateAvgSalary2($jobListings)
{
...
<body class="bg-gray-100">
  ...
  <div class="container mx-auto p-4 mt-4">
    <div class="bg-green-100 rounded-lg shadow-md p-6 my-6">
      ...
      <?= calculateAvgSalary($listings) ?>
    </div>
    <div class="bg-red-100 rounded-lg shadow-md p-6 my-6">
      <h2 class="text-2xl font-semibold mb-4">Average Salary:</h2>
      <?= calculateAvgSalary2($listings) ?>
    </div>
    <!-- Output -->
